    ...
    <div className={classes.root}>
      ...
      <div className={classes.Content}>
        <div className={classes.sort}>
          <p>
            안녕하세요 저희는 '더 나은 세상'이라는 사회적 가치 실현에 중점을
            두고있는 개발자들입니다.
          </p>
          <p>
            호떡장사를 하시는 농아인분이 손님과의 의사소통에 불편함을 느끼시는
            것을 보고, 해당 문제점을 해결하고자 이번 웹앱프로젝트를 준비하게
            되었습니다.
          </p>
          <p>
            각광받고 있는 TensorFlow AI기술을 이용하여 농아인과 보다 더 가까운
            세상을 그려보고자 합니다.
          </p>
        </div>
      </div>
        ...
        <div className={classes.Person}>
          ...
          <div className={classes.Description}>
            <span className={classes.sort}>
              ...
              <p>- 역할 : React, Serviceworker/PWA, MongoDB, Tensorflow 학습</p>
            </span>
          </div>
        </div>
